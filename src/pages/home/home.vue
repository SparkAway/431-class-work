...
<div class="recommend" :style='{"border":"0px solid #dfdfdf","boxShadow":"0px 0px 0px #eee","padding":"0","margin":"20px auto","borderColor":"#98c6e2","display":"flex","overflow":"hidden","borderRadius":"0","flexWrap":"wrap","background":"none","borderWidth":"0 0 8px","width":"100%","position":"relative","borderStyle":"dotted","height":"auto"}'>
    ...
    <div class="title" :style='{"padding":"0","margin":"30px auto 20px","borderRadius":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230101/6c449007e7a54a8892733c2b466c35cb.png) no-repeat center top","width":"100%","lineHeight":"56px","position":"relative","height":"56px"}'>
		<span :style='{"padding":"0","margin":"0 auto","color":"#fff","background":"nonr","display":"inline-block","fontSize":"24px","textShadow":"0px 0px 0px #eee"}'>竞赛项目推荐</span>
	</div>
	...
	<div class="list list1 index-pv1" :style='{"padding":"0 10px","margin":"0px auto","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"padding":"10px","boxShadow":"0px 0px 4px #eee","margin":"10px","borderColor":"#eee","borderRadius":"0px","background":"#fff","borderWidth":"1px","display":"inline-block","width":"23%","position":"relative","borderStyle":"solid","height":"auto"}' v-for="(item,index) in jingsaixiangmuRecommend" :key="index" @click="toDetail('jingsaixiangmuDetail', item)" class="list-item animation-box">
			<img :style='{"cursor":"pointer","boxShadow":"0px 0px 0px #ddd","padding":"10px","borderColor":"#9dcde9","objectFit":"cover","borderRadius":"0","borderWidth":"4px","background":"#fff","display":"block","width":"100%","borderStyle":"dotted","height":"240px"}' v-if="preHttp(item.jingsaifengmian)" :src="item.jingsaifengmian.split(',')[0]" alt="" />
			<img :style='{"cursor":"pointer","boxShadow":"0px 0px 0px #ddd","padding":"10px","borderColor":"#9dcde9","objectFit":"cover","borderRadius":"0","borderWidth":"4px","background":"#fff","display":"block","width":"100%","borderStyle":"dotted","height":"240px"}' v-else :src="baseUrl + (item.jingsaifengmian?item.jingsaifengmian.split(',')[0]:'')" alt="" />
			<div class="name line1" :style='{"cursor":"pointer","padding":"4px 10px","boxShadow":"0px 0px 0px #f1e288","margin":"0px auto 0 auto","borderColor":"#9dcde9","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderRadius":"0","background":"#fff","borderWidth":"0 0 1px","width":"100%","lineHeight":"24px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dotted"}'>{{item.jingsaimingcheng}}</div>
			<div class="name line1" :style='{"cursor":"pointer","padding":"4px 10px","boxShadow":"0px 0px 0px #f1e288","margin":"0px auto 0 auto","borderColor":"#9dcde9","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderRadius":"0","background":"#fff","borderWidth":"0 0 1px","width":"100%","lineHeight":"24px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dotted"}'>{{item.jingsaileibie}}</div>
			<div class="name line1" :style='{"cursor":"pointer","padding":"4px 10px","boxShadow":"0px 0px 0px #f1e288","margin":"0px auto 0 auto","borderColor":"#9dcde9","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderRadius":"0","background":"#fff","borderWidth":"0 0 1px","width":"100%","lineHeight":"24px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dotted"}'>{{item.saishishuoming}}</div>
		</div>
	</div>
	...
	<div @click="moreBtn('jingsaixiangmu')" :style='{"border":"0px solid #ffa100","cursor":"pointer","boxShadow":"0px 0px 0px #ddd5c6,inset 0px 0px 0px 0px #ffa100","padding":"0 20px","margin":"20px auto 40px","borderColor":"#9dcde9","textAlign":"center","display":"block","borderRadius":"0px","background":"#fff","borderWidth":"8px 0px 6px 0px","width":"130px","lineHeight":"40px","borderStyle":"dotted"}'>
	...
	<!-- 关于我们 -->
	<div :style='{"padding":"40px 30px 40px","boxShadow":"0 1px 6px rgba(255, 255, 255, .3)","margin":"20px auto 20px","borderColor":"#98c6e2","display":"flex","justifyContent":"center","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"none","borderWidth":"0 0 8px","width":"100%","position":"relative","borderStyle":"dotted","height":"auto","order":"0"}'>
	  <div :style='{"padding":"0px ","margin":"0 0 40px","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230101/6c449007e7a54a8892733c2b466c35cb.png) no-repeat center top","width":"100%","lineHeight":"56px","fontSize":"24px","textShadow":"0px 0px 0px #eee","zIndex":"9","height":"56px"}'>{{aboutUsDetail.title}}</div>
	  <div :style='{"padding":"0px 20px 0px  20px ","margin":"0 0 80px 0px","color":"#999","textAlign":"left","background":"#d4f2f3","display":"none","width":"50%","lineHeight":"50px","fontSize":"24px","zIndex":"9","height":"50px"}'>{{aboutUsDetail.subtitle}}</div>
	  <div :style='{"width":"50%","padding":"0","flexWrap":"wrap","display":"flex","height":"auto"}'>
	    <img :style='{"boxShadow":"-1px 0px 0px #eee","padding":"10px","margin":"0px","borderColor":"#9dcde9","objectFit":"cover","borderRadius":"0","borderWidth":"8px 0px 8px 0px","background":"#fff","display":"block","width":"100%","borderStyle":"dotted","height":"400px"}' :src="baseUrl + aboutUsDetail.picture1">
	  ...
	  <div :style='{"padding":"20px","boxShadow":"1px 0px 0px #eee","margin":"20px 0 20px 0","borderColor":" #9dcde9","color":"rgb(102, 102, 102)","display":"inline-block","float":"right","textIndent":"2em","overflow":"hidden","borderRadius":"0px","background":"#fff","borderWidth":"8px 0px 8px 0px","width":"50%","lineHeight":"2","fontSize":"16px","borderStyle":"dotted","zIndex":"9"}' v-html="aboutUsDetail.content"></div>
	  <div :style='{"margin":"80px 0 40px 0px","background":"url() no-repeat center top","display":"none","width":"600px","position":"absolute","height":"400px","zIndex":"1"}' />
	  <div :style='{"width":"285px","background":"url(\"http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg\") 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
	  <div :style='{"width":"285px","background":"url(\"http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg\") 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
	  <div :style='{"width":"285px","background":"url(\"http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg\") 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
	</div>
		...
		getList() {
          ...
          if(localStorage.getItem('Token')) {
			...
			this.$http.get(autoSortUrl, {params: {
				...
				if (res.data.code == 0) {
					this.jingsaixiangmuRecommend = res.data.data.list;
