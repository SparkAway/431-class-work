    ...
    <el-tabs tab-position="left" :style='{"padding":"20px","margin":"20px auto 30px auto","flexWrap":"wrap","background":"none","display":"block","width":"100%","justifyContent":"space-between"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="120px">
          ...
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='xuesheng'" label="邮箱" prop="youxiang">
            <el-input v-model="sessionForm.youxiang" placeholder="邮箱" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='xuesheng'" label="手机号码" prop="shoujihaoma">
            <el-input v-model="sessionForm.shoujihaoma" placeholder="手机号码" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='xuesheng'" label="年级" prop="nianji">
            <el-input v-model="sessionForm.nianji" placeholder="年级" ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='xuesheng'" label="班级" prop="banji">
            <el-input v-model="sessionForm.banji" placeholder="班级" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='xuesheng'" label="所属学院" prop="suoshuxueyuan">
            <el-input v-model="sessionForm.suoshuxueyuan" placeholder="所属学院" ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='laoshi'" label="工号" prop="gonghao">
            <el-input v-model="sessionForm.gonghao" placeholder="工号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='laoshi'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='laoshi'" label="老师姓名" prop="laoshixingming">
            <el-input v-model="sessionForm.laoshixingming" placeholder="老师姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='laoshi'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='laoshi'" label="邮箱" prop="youxiang">
            <el-input v-model="sessionForm.youxiang" placeholder="邮箱" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='laoshi'" label="联系手机" prop="lianxishouji">
            <el-input v-model="sessionForm.lianxishouji" placeholder="联系手机" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='laoshi'" label="职称">
          ...
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='laoshi'" label="所属学院" prop="suoshuxueyuan">
            <el-input v-model="sessionForm.suoshuxueyuan" placeholder="所属学院" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #eee","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='laoshi'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="laoshitouxiangHandleAvatarSuccess">
              <img :style='{"border":"2px dotted #9dcde9","cursor":"pointer","minHeight":"100px","color":"#9dcde9","borderRadius":"0px","textAlign":"center","background":"none","width":"200px","fontSize":"32px","lineHeight":"100px","height":"auto"}' v-if="sessionForm.touxiang" :src="baseUrl + sessionForm.touxiang" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('xuesheng' == this.userTableName) {
        this.$set(this.sessionForm, 'nianji', null);
      }
      if ('xuesheng' == this.userTableName) {
      ...
      if ('xuesheng' == this.userTableName) {
        this.$set(this.sessionForm, 'suoshuxueyuan', null);
      }
      if ('xuesheng' == this.userTableName) {
        this.$set(this.sessionForm, 'touxiang', null);
      }
      if ('laoshi' == this.userTableName) {
      ...
      if ('laoshi' == this.userTableName) {
        this.$set(this.sessionForm, 'laoshixingming', null);
      }
      if ('laoshi' == this.userTableName) {
        this.$set(this.sessionForm, 'xingbie', null);
      }
      ...
      if ('xuesheng' == this.userTableName) {
        this.$set(this.rules, 'suoshuxueyuan', [{ required: true, message: '请输入所属学院', trigger: 'blur' }]);
      }
      if ('laoshi' == this.userTableName) {
      ...
      if ('laoshi' == this.userTableName) {
        this.$set(this.rules, 'laoshixingming', [{ required: true, message: '请输入老师姓名', trigger: 'blur' }]);
      }
			if ('laoshi' == this.userTableName) {
        this.$set(this.rules, 'youxiang', [{ required: false, validator: this.$validate.isEmail, trigger: 'blur' }]);
      }
    ...
    methods: {
      ...
      laoshitouxiangHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('laoshi' == this.userTableName) {
            this.sessionForm.touxiang = 'upload/' + res.file;
          }
...
<style rel="stylesheet/scss" lang="scss" scoped>
  ...
  .center-preview .el-tabs >>> .el-tabs__header {
	border-radius: 0;
	padding: 0px;
  ...
  .center-preview .el-tabs >>> .el-tabs__header .el-tabs__item {
  	padding: 0 0px;
  	margin: 0 0 0px;
  	color: #333;
  	white-space: nowrap;
  ...
  .center-preview .el-tabs >>> .el-tabs__header .el-tabs__item:hover {
  	border-radius: 0;
  	padding: 0 10px;
  	box-shadow: 0px 0px 0px #eee;
  	margin: 0 0 0px;
  ...
  .center-preview .el-tabs >>> .el-tabs__header .el-tabs__item.is-active {
  	padding: 0 10px;
  	margin: 0;
  	color: #fff;
  	font-weight: 500;
  ...
  .center-preview .el-tabs >>> .el-tabs__content .el-tab-pane {
  	padding: 20px 10px;
  ...
  .center-preview-pv .el-form-item >>> .el-form-item__label {
  	padding: 0 10px 0 0;
  	color: #666;
  	font-weight: 500;
  	width: 120px;
  ...
  .center-preview-pv .el-input >>> .el-input__inner {
  	border-radius: 4px;
  	padding: 0 12px;
  	outline: none;
  	color: #666;
  ...
  .center-preview-pv .el-select >>> .el-input__inner {
  	border-radius: 4px;
  	padding: 0 12px;
  	outline: none;
  	color: #666;
  ...
  .center-preview-pv .el-date-editor >>> .el-input__inner {
  	border-radius: 4px;
  ...
  .center-preview-pv >>> .avatar-uploader-icon {
  ...
  .center-preview-pv .el-form-item.balance >>> .el-input__inner {
  	padding: 0 12px;
  	margin: 0 8px 0 0;
  	color: #666;
