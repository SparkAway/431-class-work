    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.jingsaididian != '') searchWhere.jingsaididian = '%' + this.formSearch.jingsaididian + '%';
	      params['sfsh'] = '是';
        this.$http.get('laoshibaoming/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/laoshibaomingDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
